...
/**
 * Deterministic administrative summary aggregating multiple governance indicators for a specific scope.
 *
 * <p>Represents CURRENT/LIVE database calculations. Does NOT persist the result.
 */
