...
| 2     | Domain foundation: authentication, JWT, RBAC, user/role entities, first land-record persistence      | Not started |
| 3     | Land record management with PostGIS geometry and spatial queries                                     | Not started |
